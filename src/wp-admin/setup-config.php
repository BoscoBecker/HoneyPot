...
$logFile = "yourdir/honeypot_log.txt";
...
// Create log string
$logEntry = "Page: /setup-config.php " . date("Y-m-d H:i:s") . " - IP: $ip - Country: $country - City: $city - ISP: $isp - Proxy: " . ($isProxy ? "YES" : "NO") . " - VPN: " . ($isVPN ? "YES" : "NO") . " - Accesses: $attemptCount - Agent: $userAgent - Headers: $headers\n";
